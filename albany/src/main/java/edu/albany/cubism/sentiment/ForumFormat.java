...
//    }
    ...
    public static void Test(String sortedOutput) throws FileNotFoundException, IOException {
        ...
        //String sortedOutput = "/home/tejasrao/Documents/tejas_look_in_here/forum_wrong_sorted.txt";
        String outputFile = Settings.getValue("kbp_data_path")+"/forum_wrong_merged.txt";
