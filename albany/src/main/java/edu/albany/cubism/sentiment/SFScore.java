...
public class SFScore {
    ...
    public static void main (String[] args) throws IOException {
        ...
        args = new String[]{Settings.getValue("kbp_data_path")+"/2014evaluation/annotation/tac_2014_kbp_english_sentiment_slot_filling_evaluation_annotations.tab", Settings.getValue("kbp_data_path")+"/2014evaluation/annotation/sample-sentiment-submission.txt"};
