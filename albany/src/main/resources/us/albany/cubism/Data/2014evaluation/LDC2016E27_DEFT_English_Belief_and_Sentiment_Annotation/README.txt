...
This package contains belief-sentiment annotation
...
This package includes an initial version of the annotation files. 
Future versions of the package will include additional annotation files,
as well as updates to the current set of files if errors are discovered
during ongoing quality control efforts.
...
data/
  ...
  annotation/  - directory containing Belief/Sentiment annotation files (*.best.xml)

docs/
  deft_anomaly_belief_sentiment_guidelines_v1.2.pdf  - annotation guidelines
  deft_rich_ere.1.1.dtd - Document Type Definition for *.rich_ere.xml files
  belief_sentiment.1.1.0.dtd - Document Type Definition for *.best.xml files
  belief_sentiment.1.1.0.rng - Relax-NG specification for *.best.xml files
...
-------------------------------------------------------------------------------
discussion forum          56   36620                3066                    935
...
"annotation_text" elements from the *.best.xml files in order for
...
The targets of belief and/or sentiment are entity, relation, and event 
mentions annotated in DEFT Rich ERE. The holders of belief/sentiment 
are entity mentions annotated in DEFT Rich ERE. Beliefs and
sentiments toward other targets are not annotated. In some cases, the 
holder of a belief/sentiment in the text is not an annotated as an ERE 
entity and is therefore unavailable for annotation as the source of the 
belief/sentiment. In these cases, the source attribute is empty.
